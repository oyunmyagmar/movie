  ...
  return (
    <Carousel className="w-[1440px] h-[600px] bg-amber-400 mt-6">
      <CarouselContent>
        <CarouselItem>
          <HeroCard
            image="https://cdn2.nbcuni.com/NBCUniversal/styles/newsroom_stories_16_9_image_style/s3/2024-11/WKD_TVSlide_1920x1080pxH_Reach_8.jpg?VersionId=oZ2_V7nGiB8s1LNXgKNOMBkGktfvzSzy&h=d1cb525d&itok=SIZUx0XE"
            label="Now Playing:"
            title="Wicked"
            score={6.9}
            description="Elphaba, a misunderstood young woman because of her green skin, and
        ...
        <CarouselItem>
          <HeroCard
            image="https://i2.wp.com/pocculture.com/wp-content/uploads/2024/07/G2_DOM_Online_Teaser_1-Sheet_07_FIN4-min-e1720569522171.jpg?w=999&ssl=1"
            label="Now Playing:"
            title="Gladiator II"
            score={6.9}
            description="After his home is conquered by the tyrannical emperors who now
        ...
        <CarouselItem>
          <HeroCard
            ...
            title="Moana 2"
            score={6.9}
            description="After receiving an unexpected call from her wayfinding
